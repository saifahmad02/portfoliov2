  ...
  return (
    <aside className="lg:sticky lg:top-0 lg:h-screen lg:flex lg:flex-col lg:justify-between py-10 lg:py-20">
      <div>
        ...
        {profileData.resumeUrl && (
          <a
            ...
            className="hidden lg:inline-flex items-center gap-3 px-4 py-3 border border-border rounded-lg font-mono text-sm text-foreground hover:text-accent hover:border-accent transition-all duration-200 group mb-6"
          >
            <svg
            ...
            <svg
              className="w-4 h-4 ml-auto text-muted group-hover:text-accent transition-colors"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              viewBox="0 0 24 24"
      ...
      <div className="mt-auto">
        ...
        {/* Social Icons + Resume Button - Mobile only */}
